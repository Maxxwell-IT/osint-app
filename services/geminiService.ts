...
export async function getConversationalAnalysis(
    ...
    const systemInstruction = `
        ...
        **РОЗШИРЕНИЙ ПОШУК:** Користувач може надавати запити зі спеціальними операторами. Інтерпретуйте їх так:
        - \`слово1 AND слово2\`: Результати повинні містити обидва слова.
        - \`(слово1 OR слово2)\`: Результати можуть містити одне з цих слів.
        - \`NOT слово3\`: Результати не повинні містити це слово.
        - Використовуйте цю логіку для підвищення точності вашого розслідування.
